...
class VerifyEmailCest
{
    ...
    {
        $I->amOnRoute('auth/signup/confirm', ['token' => '']);
    ...
    {
        $I->amOnRoute('auth/signup/confirm', ['token' => 'wrong_token']);
        $I->canSee('Bad Request', 'h1');
    ...
    {
        $I->amOnRoute('auth/signup/confirm');
        $I->canSee('Bad Request', 'h1');
    ...
    {
        $I->amOnRoute('auth/signup/confirm', ['token' => 'already_used_token_1548675330']);
        $I->canSee('Bad Request', 'h1');
        $I->canSee('Wrong verify email token.');
    }
    ...
    {
        $I->amOnRoute('auth/signup/confirm', ['token' => '4ch0qbfhvWwkcuWqjN8SWRq72SOw1KYT_1548675330']);
